...
@XmlRootElement(name = "j_guest_wl")
@Entity(name = "j_guest_wl")
public class J_Guest_WL implements Serializable{
	...
	@Column(name = "j_guest_wl_id", nullable = false)
	@GeneratedValue(strategy = GenerationType.AUTO)
	private long jGuestWLId;
