...
public class SeatingArrangementDAO { 
    ...
    {
      TypedQuery<SeatingArrangement> query = EM.getEM().createQuery("SELECT seating_arrangement FROM seating_arrangement seating_arrangement", SeatingArrangement.class);
    ...
    {
      String qString = "SELECT seating_arrangement FROM seating_arrangement seating_arrangement  WHERE seating_arrangement.seating_arrangement_id ="+idNumber;
